...
export type AllSanitySchemaTypes = Achievement | SanityImageCrop | SanityImageHotspot | SiteSettings | Certification | Education | Service | Slug | Blog | Navigation | Contact | Testimonial | Skill | Project | Experience | Profile | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
